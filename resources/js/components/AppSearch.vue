...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            clearStoreAndReload() {
                window.localStorage.removeItem(this.vars.localStorageKey)
                window.localStorage.removeItem(this.vars.localStorageVersionKey)
                window.location.reload(true)
            },
        },
        created: function() {
