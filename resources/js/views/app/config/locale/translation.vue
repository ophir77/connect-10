<template>
    <base-container boxed with-loader :is-loading="isLoading" :loader-color="vars.loaderColor" class="p-0 flex-grow">
        ...
        <b-modal size="md" centered lazy :busy="isModalLoading" ref="localeEditModal" v-model="showLocaleEditModal" no-close-on-backdrop no-close-on-esc @ok="onLocaleEditModalOK" @hidden="onLocaleEditModalHidden">
            ...
            <div>
                <div class="row">
                    <div class="col-12">
                        <base-input class="mb-5" :label="`${modalData.label} (${modalData.locale})`" type="text" v-model="modalData.translation" :error.sync="formErrors.translation" />
                    </div>
                </div>
