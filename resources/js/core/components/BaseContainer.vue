<template>
    <div class="base-container page-container" :class="{'boxed': boxed, 'boxed-right': boxed === 'right', 'boxed-left': boxed === 'left', 'min-height': minHeight, 'min-height-sm': minHeight === 'sm', 'min-height-md': minHeight === 'md', 'min-height-lg': minHeight === 'lg', 'h-100': minHeight === 'full', 'has-form': hasForm, 'has-footer': hasFooter }">
