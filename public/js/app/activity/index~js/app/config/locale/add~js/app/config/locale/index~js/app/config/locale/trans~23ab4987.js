(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["js/app/activity/index~js/app/config/locale/add~js/app/config/locale/index~js/app/config/locale/trans~23ab4987"],{
...
var headerRouteButton = function headerRouteButton(label, icon, route) {
  ...
  return _objectSpread({}, headerButton({
    label: label,
    icon: icon,
    tooltip: tooltip,
    design: design
...
var headerPermittedRouteButton = function headerPermittedRouteButton(label, icon, route, permission) {
  ...
  return _objectSpread({}, headerRouteButton(label, icon, route, tooltip, design, params, query), {
...
var headerPermittedActionButton = function headerPermittedActionButton(label, icon, action, permission) {
  var tooltip = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;
  var design = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : null;
  return _objectSpread({}, headerActionButton(label, icon, action, tooltip, design), {
    permissions: [permission]
  });
};
...
var headerPermittedEventButton = function headerPermittedEventButton(label, icon, eventOpts, permission) {
  var tooltip = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;
  var design = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : null;
  return _objectSpread({}, headerEventButton(label, icon, eventOpts, tooltip, design), {
    permissions: [permission]
  });
};
...
var getSortOptions = function getSortOptions() {
  ...
  return _objectSpread({}, defaultSortOptions, {}, options, {
    options: [{
...
var headerRouteLink = function headerRouteLink(label, icon, route) {
  ...
  return _objectSpread({}, headerLink({
    label: label,
    icon: icon
  }), {
    to: {
...
var headerPermittedRouteLink = function headerPermittedRouteLink(label, icon, route, permission) {
  ...
  return _objectSpread({}, headerRouteLink(label, icon, route, params, query), {
    permissions: [permission]
  });
};
...
var headerPermittedActionLink = function headerPermittedActionLink(label, icon, action, permission) {
  return _objectSpread({}, headerActionLink(label, icon, action), {
    permissions: [permission]
  });
};
...
var headerPermittedEventLink = function headerPermittedEventLink(label, icon, eventOpts, permission) {
  return _objectSpread({}, headerEventLink(label, icon, eventOpts), {
    permissions: [permission]
  });
};
...
var commonKeyBindings = _objectSpread({}, keyBindings.filter, {}, keyBindings.print, {}, keyBindings["export"]);

/***/ })

}]);
//# sourceMappingURL=trans~23ab4987.js.map?id=aa811f083cffe88746db